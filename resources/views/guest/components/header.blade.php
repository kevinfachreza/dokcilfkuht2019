<div class="container  position-relative py-5" style="min-height: 643px;" id="home">
				...
				<div class="row align-items-center  py-5" style="margin-top: 50px">
					...
					<div class="col-lg-6 text-center mt-5 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="550">
						<img src="https://rsal.medifyapp.com/assets/img/error-500-doctordinosaur-color.svg" style="height: 200px" class="img-fluid" alt="" data-plugin-float-element data-plugin-options="{'startPos': 'none', 'speed': 8, 'transition': true, 'horizontal': true}" />
					</div>
				</div>
			</div>